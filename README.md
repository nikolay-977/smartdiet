**Тема диплома:** «Разработка системы дневника питания с системой рекомендации продуктов»
...
**Цель работы:** Разработать кроссплатформенную систему дневника питания, которая предоставляет персонализированные рекомендации по продуктам для достижения пользователем заданных nutritional-целей.
...
*   **Backend:** Kotlin, Spring Boot (Web, Security, Data JPA)
