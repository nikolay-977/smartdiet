...
4.  Разработать алгоритмы для двух основных сценариев рекомендаций:
    *   Рекомендация отдельных продуктов для поддержания необходимого уровня микроэлементов.
...
*   Рекомендации носят общий характер, не персонализированы под необходимый уровень конкретных витаминов и микроэлементов.
...
*   Уникальные алгоритмы рекомендаций, основанные на приоритете выполнения нормы для необходимого уровня витаминов и микроэлементов.
