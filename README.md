...
5.  **AI-ассистент:**
    *   Встроенный чат, где пользователь может задавать вопросы на тему питания ("Почему у меня может быть дефицит магния?", "Дай идеи для ужина с высоким содержанием белка", "Объясни, что такое гликемический индекс").
...
*   **USER_GOAL и NUTRIENT_TARGET:** Позволяют гибко настраивать цели не только по калориям, но и по конкретным микронутриентам.
...
*   **Элементы:** Визуальные прогресс-бары по ключевым макро- и микроэлементам, выявленным в дефиците. Кнопки для основных действий.

**2. Экран рекомендаций (Сценарий 1: Восполнение дефицита)**
```
Рекомендации для вас > Восполнить дефицит
-------------------------------------------------
Цель: Восполнить дефицит по [Железо ▼] (осталось 14.8 мг)
...
... (и так 7 продуктов)
```
*   **Цель:** Наглядно показать пользователю самые эффективные продукты для решения его конкретной проблемы.
